...
`.vfst`, `.hfstol`, `.hfst`) in-tree, and does not commit the
generated factual tables either. The runtime loads tables from disk
under `localdata/lemmatizer-fi-et/tables/` (gitignored); see
