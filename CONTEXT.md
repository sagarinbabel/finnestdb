...
The unsigned public alpha surface: paste text, parse it, get a parsed word list,
and explore the list. It proves parser quality before signup, but it is
stateless and ephemeral. It uses a stricter configurable text-size cap than
signed-in parsing.
